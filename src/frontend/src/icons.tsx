...
export const AppleLogo = () => (
    <svg
        ...
        aria-hidden="true"
    >
        <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.22-.06 2.07.67 2.79.67.71 0 2.05-.88 3.45-.75.59.03 2.23.24 3.29 1.78-.08.05-1.96 1.14-1.94 3.47.03 2.78 2.43 3.7 2.46 3.71-.03.07-.39 1.32-2.05 4.09M12.03 7.22C11.88 5 13.69 3.17 15.77 3c.29 2.57-2.34 4.49-3.74 4.22" />
    </svg>
);
...
export const GoogleLogo = () => (
    ...
    >
        <path
            fill="#4285f4"
            d="M23.49 12.27c0-.79-.07-1.54-.2-2.27H12v4.51h6.45a5.52 5.52 0 0 1-2.39 3.52v2.93h3.87c2.27-2.09 3.56-5.17 3.56-8.69"
        />
        <path
            fill="#34a853"
            d="M12 24c3.24 0 5.96-1.07 7.95-2.91l-3.87-3c-1.08.72-2.45 1.15-4.08 1.15-3.13 0-5.78-2.11-6.73-4.95H1.28v3.04A12 12 0 0 0 12 24"
        />
        <path
            fill="#fbbc04"
            d="M5.27 14.29A7.22 7.22 0 0 1 4.9 12c0-.8.14-1.58.37-2.29V6.67H1.28A12 12 0 0 0 0 12c0 1.94.46 3.78 1.28 5.33l3.99-3.04"
        />
        <path
            fill="#ea4335"
            d="M12 4.77c1.76 0 3.34.61 4.58 1.8l3.44-3.44A11.52 11.52 0 0 0 12 0 12 12 0 0 0 1.28 6.67l3.99 3.04C6.22 6.87 8.87 4.77 12 4.77"
        />
    </svg>
);
