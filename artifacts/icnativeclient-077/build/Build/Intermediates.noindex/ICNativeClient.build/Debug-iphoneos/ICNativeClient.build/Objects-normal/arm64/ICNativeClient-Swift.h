...
#ifndef ICNATIVECLIENT_SWIFT_H
#define ICNATIVECLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ICNativeClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ICNativeClient31ICInternetIdentityAuthenticator") SWIFT_AVAILABILITY(ios,introduced=17.4)
@interface ICInternetIdentityAuthenticator : NSObject <ASWebAuthenticationPresentationContextProviding>
