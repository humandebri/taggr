...
#ifndef TAGGR_SWIFT_H
#define TAGGR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TAGGR",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSString;
SWIFT_CLASS("_TtC5TAGGR16TAGGRAppDelegate")
@interface TAGGRAppDelegate : NSObject <UIApplicationDelegate>
