...
const hasNoPlaceholders = () => {
    const review = read("docs/ios/app_store_review.md");
    return ![
...
const deviceEvidenceComplete = () => {
    const deviceDoc = read("docs/ios/device_verification.md");
    return (
...
check(
    run("production canister controller access is available", "dfx", [
        "--identity",
        identity,
        "canister",
        "--network",
